    ...
    return Scaffold(
      ...
      body: ListView(
        children: const <Widget>[
          ...
          DemoItem('No center mode demo', '/center'),
          ...
          DemoItem('Noon-looping carousel slider', '/loop'),
